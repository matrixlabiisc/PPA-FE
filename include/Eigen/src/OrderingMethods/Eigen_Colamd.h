...
#  define COLAMD_NDEBUG
    ...
    */
    ...
    template <typename IndexType>
    static IndexType
    init_rows_cols(IndexType               n_row,
                   IndexType               n_col,
    ...
    template <typename IndexType>
    static void
    order_children(IndexType               n_col,
                   ColStructure<IndexType> Col[],
                   IndexType               p[]);

    template <typename IndexType>
    static void
    detect_super_cols(ColStructure<IndexType> Col[],
                      IndexType               A[],
                      IndexType               head[],
                      IndexType               row_start,
    ...
    template <typename IndexType>
    static IndexType
    garbage_collection(IndexType               n_row,
                       IndexType               n_col,
                       RowStructure<IndexType> Row[],
                       ColStructure<IndexType> Col[],
                       IndexType               A[],
...
#define COLAMD_ASSERT(expression) ((void)0)
    ...
    template <typename IndexType>
    static bool
    compute_ordering(IndexType  n_row,
                     IndexType  n_col,
                     IndexType  Alen,
                     IndexType *A,
                     IndexType *p,
    ...
    */
    ...
    )
    {
      ...
      dense_row_count =
        numext::maxi(IndexType(0),
                     numext::mini(IndexType(knobs[Colamd::DenseRow] * n_col),
                                  n_col));
      dense_col_count =
        numext::maxi(IndexType(0),
                     numext::mini(IndexType(knobs[Colamd::DenseCol] * n_row),
                                  n_row));
      COLAMD_DEBUG1(
