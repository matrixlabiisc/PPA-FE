...
namespace Eigen
{
  namespace internal
  {
     ...
     * major format. \param[out] perm the permutation P reducing the fill-in of
     * the input matrix \a C
     *
     * Note that the input matrix \a C must be complete, that is both the upper
     * and lower parts have to be stored, as well as the diagonal entries. On
     * exit the values of C are destroyed */
      ...
      while (nel < n) /* while (selecting pivots) do */
        {
          ...
          mark      = internal::cs_wclear<StorageIndex>(mark + lemax,
                                                   lemax,
                                                   w,
                                                   n); /* clear w */
