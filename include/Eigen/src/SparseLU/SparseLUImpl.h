...
namespace Eigen
{
  namespace internal
  {
    ...
    protected:
      ...
      template <typename VectorType>
      Index
      memXpand(VectorType &vec,
               Index &     maxlen,
               Index       nbElts,
               MemType     memtype,
               Index &     num_expansions);
      void
      heap_relax_snode(const Index  n,
                       IndexVector &et,
                       const Index  relax_columns,
                       IndexVector &descendants,
                       IndexVector &relax_end);
      void
      relax_snode(const Index  n,
                  IndexVector &et,
                  const Index  relax_columns,
                  IndexVector &descendants,
                  IndexVector &relax_end);
      Index
      snode_dfs(const Index       jcol,
                const Index       kcol,
                ...
                GlobalLU_t &      glu);
      Index
      snode_bmod(const Index   jcol,
                 const Index   fsupc,
                 ScalarVector &dense,
                 GlobalLU_t &  glu);
      Index
      pivotL(const Index       jcol,
      ...
      void
      dfs_kernel(const StorageIndex jj,
                 IndexVector &      perm_r,
                 Index &            nseg,
      ...
      pruneL(const Index        jcol,
             ...
             GlobalLU_t &       glu);
      void
      countnz(const Index n, Index &nnzL, Index &nnzU, GlobalLU_t &glu);
      void
