...
namespace Eigen
{
   ...
   * \tparam Rows the number of rows of the reshape we are taking at compile
   * time (optional) \tparam Cols the number of columns of the reshape we are
   * taking at compile time (optional) \tparam Order can be ColMajor or
   * RowMajor, default is ColMajor.
   *
   ...
   * you will need to use this class. In C++11, it is advised to use the \em
   * auto keyword for such use cases.
   *
  ...
  template <typename XprType, int Rows, int Cols, int Order>
  class Reshaped
    : public ReshapedImpl<XprType,
                          Rows,
                          Cols,
                          Order,
                          typename internal::traits<XprType>::StorageKind>
  {
    typedef ReshapedImpl<XprType,
                         Rows,
                         Cols,
                         Order,
                         typename internal::traits<XprType>::StorageKind>
  ...
  namespace internal
  {
    ...
    template <typename ArgType, int Rows, int Cols, int Order>
    struct reshaped_evaluator<ArgType,
                              Rows,
                              Cols,
                              Order,
