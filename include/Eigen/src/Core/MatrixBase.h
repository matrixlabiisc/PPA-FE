...
#undef EIGEN_DOC_UNARY_ADDONS
    ...
    template <typename OtherDerived>
    void
    applyOnTheLeft(const EigenBase<OtherDerived> &other);

    template <typename OtherDerived>
    void
    applyOnTheRight(const EigenBase<OtherDerived> &other);
    ...
    NoAlias<Derived, Eigen::MatrixBase> EIGEN_DEVICE_FUNC
                                        noalias();
    ...
    inline const FullPivLU<PlainObject>
    fullPivLu() const;
    inline const PartialPivLU<PlainObject>
    partialPivLu() const;
    ...
    template <typename ResultType>
    inline void
    computeInverseWithCheck(ResultType &      inverse,
                            bool &            invertible,
                            const RealScalar &absDeterminantThreshold =
                              NumTraits<Scalar>::dummy_precision()) const;
    ...
    inline const HouseholderQR<PlainObject>
    householderQr() const;
    ...
    eulerAngles(Index a0, Index a1, Index a2) const;
    ...
    typedef Block<
      ...
      ConstStartMinusOne;
    typedef EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(ConstStartMinusOne,
                                                   Scalar,
                                                   quotient)
    ...
    EIGEN_DEVICE_FUNC
    void
    makeHouseholderInPlace(Scalar &tau, RealScalar &beta);
    template <typename EssentialPart>
    EIGEN_DEVICE_FUNC void
    makeHouseholder(EssentialPart &essential,
                    Scalar &       tau,
                    RealScalar &   beta) const;
    template <typename EssentialPart>
    EIGEN_DEVICE_FUNC void
    applyHouseholderOnTheLeft(const EssentialPart &essential,
                              const Scalar &       tau,
                              Scalar *             workspace);
    template <typename EssentialPart>
    EIGEN_DEVICE_FUNC void
...
#define EIGEN_MATRIX_FUNCTION_1(ReturnType, Name, Description, Argument)     \
  ...
  const ReturnType<Derived> Name(Argument) const;
    ...
    EIGEN_MATRIX_FUNCTION(MatrixFunctionReturnValue,
                          atanh,
    ...
    EIGEN_MATRIX_FUNCTION_1(MatrixPowerReturnValue,
                            pow,
                            power to \c       p,
                            const RealScalar &p)
    EIGEN_MATRIX_FUNCTION_1(MatrixComplexPowerReturnValue,
                            pow,
                            power to \c                     p,
  ...
  protected:
    ...
    operator+=(const ArrayBase<OtherDerived> &)
    {
      EIGEN_STATIC_ASSERT(std::ptrdiff_t(
                            sizeof(typename OtherDerived::Scalar)) == -1,
