...
namespace Eigen
{
  namespace internal
  {
    ...
    /** \internal
     * \brief Template functor to arithmetically shift a scalar right by a
     * number of bits
     *
    ...
    /** \internal
     * \brief Template functor to logically shift a scalar left by a number of
     * bits
     *
...
// The following numbers are based on the AVX implementation,
    ...
    /** \internal
     * \brief Template functor to compute the rounded (with current rounding
     * mode)  value of a scalar \sa class CwiseUnaryOp, ArrayBase::rint()
     */
    template <typename Scalar>
