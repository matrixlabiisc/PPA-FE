...
namespace Eigen
{
  namespace internal
  {
    ...
    {
      typedef
        typename ScalarBinaryOpTraits<LhsScalar, RhsScalar, scalar_sum_op>::
    ...
    template <>
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE bool
    scalar_product_op<bool, bool>::operator()(const bool &a,
                                              const bool &b) const
    {
      return a && b;
    }
    ...
    struct scalar_conj_product_op : binary_op_base<LhsScalar, RhsScalar>
    {
      ...
      typedef typename ScalarBinaryOpTraits<LhsScalar,
                                            RhsScalar,
                                            scalar_conj_product_op>::ReturnType
        result_type;
    ...
    {
      typedef
        typename ScalarBinaryOpTraits<LhsScalar, RhsScalar, scalar_min_op>::
          ReturnType result_type;
    ...
    {
      typedef
        typename ScalarBinaryOpTraits<LhsScalar, RhsScalar, scalar_max_op>::
          ReturnType result_type;
    ...
    {
      typedef
        typename ScalarBinaryOpTraits<LhsScalar,
                                      RhsScalar,
    ...
    //  - they are portable across C++ versions (the std::binder* are deprecated
    //  in C++11)
