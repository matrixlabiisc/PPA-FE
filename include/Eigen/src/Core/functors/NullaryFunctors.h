...
namespace Eigen
{
      ...
      enum
  {
    ...
    // available for the given functor. If it exposes an operator()(i,j), then
    // we assume the i and j coefficients are required independently and linear
    // access is not possible. In all other cases, linear access is enabled.
