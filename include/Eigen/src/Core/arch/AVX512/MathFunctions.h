...
#  if EIGEN_FAST_MATH
                                                                     ...
                                                                     psqrt<Packet16f>(const Packet16f &_x)
    {
      ...
      __mmask16 denormal_mask =
        _mm512_kand(_mm512_cmp_ps_mask(_x,
                                       pset1<Packet16f>(
      ...
      return _mm512_mask_blend_ps(denormal_mask,
                                  pmul(_x, x),
                                  _mm512_setzero_ps());
    }
                                                                     ...
                                                                     psqrt<Packet8d>(const Packet8d &_x)
    {
      ...
      __mmask16 denormal_mask =
        _mm512_kand(_mm512_cmp_pd_mask(_x,
                                       pset1<Packet8d>(
      ...
      return _mm512_mask_blend_pd(denormal_mask,
                                  pmul(_x, x),
                                  _mm512_setzero_pd());
    }
#  else
...
#  elif EIGEN_FAST_MATH
                                                                     ...
                                                                     prsqrt<Packet16f>(const Packet16f &_x)
    {
      ...
      // This will return rsqrt(+inf) = 0, rsqrt(x) = NaN if x < 0, and rsqrt(0)
      // = +inf.
