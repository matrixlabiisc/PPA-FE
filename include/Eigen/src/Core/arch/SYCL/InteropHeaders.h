...
// This function should never get called on the device
      ...
      {
        typedef
          typename ::Eigen::internal::unpacket_traits<PacketReturnType>::type
            Scalar;
          ...
          switch (index)
            {
              ...
              case 3:
                return in.w();
              default:
                // INDEX MUST BE BETWEEN 0 and 3.There is no abort function in
                // SYCL kernel. so we cannot use abort here.
          ...
          switch (index)
            {
              ...
              case 1:
                return in.y();
              default:
                // INDEX MUST BE BETWEEN 0 and 1.There is no abort function in
                // SYCL kernel. so we cannot use abort here.
                // The code will never reach here
                __builtin_unreachable();
            }
