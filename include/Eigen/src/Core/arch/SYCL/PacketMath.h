...
#  undef SYCL_PSET1
    ...
    struct get_base_packet
    {
      ...
      static EIGEN_DEVICE_FUNC
        EIGEN_STRONG_INLINE packet_type get_ploaddup(sycl_multi_pointer)
      {}

      template <typename sycl_multi_pointer>
      static EIGEN_DEVICE_FUNC
        EIGEN_STRONG_INLINE packet_type get_pgather(sycl_multi_pointer, Index)
      {}
    };
    ...
    struct get_base_packet<cl::sycl::cl_float4>
    {
      ...
      {
        return cl::sycl::cl_float4(from[0 * stride],
                                   from[1 * stride],
                                   from[2 * stride],
                                   from[3 * stride]);
      }
      ...
      static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
                               set_pscatter(sycl_multi_pointer         to,
      ...
      {
        return cl::sycl::cl_float4(static_cast<float>(a),
...
#  undef SYCL_PMAD
    ...
    {
      return cl::sycl::cl_float4(cl::sycl::fabs(a.x()),
                                 cl::sycl::fabs(a.y()),
                                 cl::sycl::fabs(a.z()),
                                 cl::sycl::fabs(a.w()));
    }
