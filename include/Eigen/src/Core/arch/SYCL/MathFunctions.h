...
#  define SYCL_PMIN(packet_type, expr)                                                                  \
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type                                                   \
                                          pmin<packet_type>(const packet_type &a, const packet_type &b) \
    {                                                                                                   \
      return expr;                                                                                      \
    }
...
#  define SYCL_PMAX(packet_type, expr)                                                                  \
    template <>                                                                                         \
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type                                                   \
                                          pmax<packet_type>(const packet_type &a, const packet_type &b) \
    {                                                                                                   \
      return expr;                                                                                      \
    }
...
#  define SYCL_PLDEXP(packet_type)                                                                  \
    template <>                                                                                     \
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE packet_type                                               \
                                          pldexp(const packet_type &a, const packet_type &exponent) \
    {                                                                                               \
