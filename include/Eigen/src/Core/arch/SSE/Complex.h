...
// to leverage AVX instructions.
                        ...
                        pmul<Packet2cf>(const Packet2cf &a, const Packet2cf &b)
    {
      ...
      //   return Packet2cf(_mm_addsub_ps(_mm_mul_ps(vec4f_swizzle1(a.v, 0, 0,
      //   2, 2), b.v),
      //                                  _mm_mul_ps(vec4f_swizzle1(a.v, 1, 1,
      //                                  3, 3),
      //                                             vec4f_swizzle1(b.v, 1, 0,
      //                                             3, 2))));
#else
      const __m128 mask = _mm_castsi128_ps(
...
// to leverage AVX instructions.
    ...
    {
      __m128d result = pblend<Packet2d>(ifPacket,
                                        _mm_castps_pd(thenPacket.v),
