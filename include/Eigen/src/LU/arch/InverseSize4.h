...
namespace Eigen
{
  namespace internal
  {
    ...
    struct compute_inverse_size4<Architecture::Target,
                                 float,
                                 MatrixType,
                                 ResultType>
    {
      ...
      run(const MatrixType &mat, ResultType &result)
      {
        ...
        AB = psub(AB,
                  pmul(vec4f_swizzle2(A, A, 1, 1, 2, 2),
                       vec4f_swizzle2(B, B, 2, 3, 0, 1)));

        // DC = D#*C
        DC = pmul(vec4f_swizzle2(D, D, 3, 3, 0, 0), C);
        DC = psub(DC,
                  pmul(vec4f_swizzle2(D, D, 1, 1, 2, 2),
        ...
        iB = psub(iB,
                  pmul(vec4f_swizzle2(D, D, 1, 0, 3, 2),
        ...
        iC = psub(iC,
                  pmul(vec4f_swizzle2(A, A, 1, 0, 3, 2),
                                 ...
                                 ResultType>
    {
      ...
      run(const MatrixType &mat, ResultType &result)
      {
        ...
        iB1 =
          psub(iB1,
               pmul(vec2d_swizzle2(D1, D1, 1), vec2d_swizzle2(AB2, AB1, 2)));
        iB2 =
          psub(iB2,
               pmul(vec2d_swizzle2(D2, D2, 1), vec2d_swizzle2(AB2, AB1, 2)));
        ...
        iC1 =
          psub(iC1,
               pmul(vec2d_swizzle2(A1, A1, 1), vec2d_swizzle2(DC2, DC1, 2)));
        iC2 =
          psub(iC2,
               pmul(vec2d_swizzle2(A2, A2, 1), vec2d_swizzle2(DC2, DC1, 2)));
