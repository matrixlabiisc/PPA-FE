...
namespace Eigen
{
   ...
   * numerical zeros (exact) C = (A*B).pruned(ref); C =
   * (A*B).pruned(ref,epsilon); \endcode where \c ref is a meaningful non zero
   * reference value.
   * */
  ...
  namespace internal
  {
    ...
    struct generic_product_impl<Lhs,
                                ...
                                ProductType>
      : public generic_product_impl<Lhs,
                                    Rhs,
                                    SparseShape,
                                    SparseShape,
                                    ProductType>
  ...
  SparseMatrix<Scalar, _Options, _StorageIndex>::
  operator=(const Product<Lhs, Rhs, AliasFreeProduct> &src)
  {
