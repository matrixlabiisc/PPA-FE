...
namespace Eigen
{
  ...
  public:
    ...
    // for vectors
    inline SparseMapBase(Index         size,
                         Index         nnz,
                         IndexPointer  innerIndexPtr,
                         ScalarPointer valuePtr)
      : m_outerSize(1)
 ...
 */
  ...
  template <typename MatScalar,
            ...
            int Options,
            typename StrideType>
  class Map<const SparseMatrix<MatScalar, MatOptions, MatIndex>,
            Options,
            StrideType>
    : public SparseMapBase<
  ...
  namespace internal
  {
    ...
    {
      typedef evaluator<
        SparseCompressedBase<Map<SparseMatrix<MatScalar, MatOptions, MatIndex>,
                                 Options,
                                 StrideType>>>
        Base;
      typedef Map<SparseMatrix<MatScalar, MatOptions, MatIndex>,
                  Options,
                  StrideType>
        XprType;
      evaluator()
