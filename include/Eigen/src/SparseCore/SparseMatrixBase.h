...
namespace Eigen
{
   ...
   * symbol \c EIGEN_SPARSEMATRIXBASE_PLUGIN.
   */
  ...
  public:
     ...
     */
    typedef typename internal::conditional<_HasDirectAccess,
                                           const Scalar &,
...
#undef EIGEN_DOC_BLOCK_ADDONS_INNER_PANEL_IF
  ...
  public:
    ...
    template <unsigned int UpLo>
    inline typename SelfAdjointViewReturnType<UpLo>::Type
    selfadjointView();
    ...
    template <typename OtherDerived>
    Scalar
    dot(const SparseMatrixBase<OtherDerived> &other) const;
    RealScalar
    squaredNorm() const;
    RealScalar
    norm() const;
