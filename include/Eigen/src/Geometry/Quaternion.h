...
namespace Eigen
{
  ...
  public:
    ...
    EIGEN_DEVICE_FUNC inline Matrix3
...
#  include EIGEN_QUATERNIONBASE_PLUGIN
   ...
   * representation of orientations and rotations of objects in three
   * dimensions. Compared to other representations like Euler angles or 3x3
   * matrices, quaternions offer the following advantages: \li \b compact
   * storage (4 scalars) \li \b efficient to compose (28 flops), \li \b stable
  ...
  public:
     ...
     * [\c x, \c y, \c z, \c w]
     */
    EIGEN_DEVICE_FUNC inline Quaternion(const Scalar &w,
                                        const Scalar &x,
                                        const Scalar &y,
                                        const Scalar &z)
      : m_coeffs(x, y, z, w)
...
#  include EIGEN_QUATERNION_PLUGIN
  ...
  namespace internal
  {
    ...
    struct traits<Map<Quaternion<_Scalar>, _Options>>
      : traits<Quaternion<_Scalar,
                          (int(_Options) & Aligned) == Aligned ? AutoAlign :
                                                                 DontAlign>>
    {
   ...
   * multiplicative inverse if the quaternion is normalized. The conjugate of a
   * quaternion represents the opposite rotation.
   *
