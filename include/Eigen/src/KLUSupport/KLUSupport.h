...
namespace Eigen
{
   ...
   * factorization using the KLU library. The sparse matrix A must be squared
  ...
  protected:
    ...
    analyzePattern_impl()
    {
      ...
      m_symbolic =
        klu_analyze(internal::convert_index<int>(mp_matrix.rows()),
