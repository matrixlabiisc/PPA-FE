...
{
  return EIGEN_CWISE_BINARY_RETURN_TYPE(Derived,
                                        OtherDerived,
...
#define EIGEN_MAKE_CWISE_COMP_OP(OP, COMPARATOR)                                          \
  template <typename OtherDerived>                                                        \
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const                                             \
                    CwiseBinaryOp<internal::scalar_cmp_op<Scalar,                         \
...
#define EIGEN_MAKE_CWISE_COMP_R_OP(OP, R_OP, RCOMPARATOR)                                 \
  template <typename OtherDerived>                                                        \
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const                                             \
                    CwiseBinaryOp<internal::scalar_cmp_op<typename OtherDerived::Scalar,  \
                                          Scalar,                         \
  ...
  {                                                                                       \
    return CwiseBinaryOp<                                                                 \
      internal::scalar_cmp_op<typename OtherDerived::Scalar,                              \
                              Scalar,                                                     \
                              internal::cmp_##RCOMPARATOR>,                               \
      const OtherDerived,                                                                 \
 ...
 */
template <typename T>
friend const CwiseBinaryOp<internal::scalar_sum_op<T, Scalar>,
                           Constant<T>,
                           Derived>
 ...
 */
template <typename T>
const CwiseBinaryOp<internal::scalar_difference_op<Scalar, T>,
                    Derived,
                    Constant<T>>
operator-(const T &scalar) const;
...
operator^(const EIGEN_CURRENT_STORAGE_BASE_CLASS<OtherDerived> &other) const
{
  ...
  return CwiseBinaryOp<internal::scalar_boolean_xor_op,
                       const Derived,
                       const OtherDerived>(derived(), other.derived());
}
...
inline const CwiseBinaryOp<internal::scalar_zeta_op<Scalar>,
                           const Derived,
                           const DerivedQ>
