...
srun /scratch/vikramg_root/vikramg1/phanim/DFT_FETesting/buildpCOHP/release/real/dftfe parameterFile_a.prm>H2_testCase_DFTFEKohnShamOrbital_slater_PAWCoor
